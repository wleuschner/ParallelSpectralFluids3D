...
void DECMesh3D::addFace(const Face3D& f,FaceDirection direction)
{
    if(faces[f.id].inside==GridState::UNINITIALIZED)
    {
        ...
        if(direction==FaceDirection::FRONT)
        {
            ...
            faces[f.id].e1 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs+1)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e2 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+(xOfs+1)+dims.x+(dims.x+1)*(dims.y+1);
            faces[f.id].e3 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e4 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+xOfs+dims.x+(dims.x+1)*(dims.y+1);
        ...
        else if(direction==FaceDirection::BACK)
        {
            ...
            unsigned int yOfs = (f.id%(dims.x*dims.y+2*(dims.x+1)*(dims.y+1)-(dims.x+1)-(dims.y+1)))/(dims.x);
            unsigned int xOfs = (f.id%(dims.x*dims.y+2*(dims.x+1)*(dims.y+1)-(dims.x+1)-(dims.y+1)))%(dims.x);
            faces[f.id].e1 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e2 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+(xOfs+1)+dims.x+(dims.x+1)*(dims.y+1);
            faces[f.id].e3 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs+1)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e4 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+(xOfs)+dims.x+(dims.x+1)*(dims.y+1);
            addEdge(Edge3D(faces[f.id].e1,f.v1,f.v2,f.inside));
            addEdge(Edge3D(faces[f.id].e2,f.v2,f.v3,f.inside));
            addEdge(Edge3D(faces[f.id].e3,f.v3,f.v4,f.inside));
        ...
        else if(direction==FaceDirection::TOP)
        {
            ...
            faces[f.id].e1 = (zOfs+1)*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e2 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(dims.x+1)+(xOfs+1);
            faces[f.id].e3 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e4 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(dims.x+1)+xOfs;
            addEdge(Edge3D(faces[f.id].e1,f.v1,f.v2,f.inside));
            addEdge(Edge3D(faces[f.id].e2,f.v2,f.v3,f.inside));
            addEdge(Edge3D(faces[f.id].e3,f.v3,f.v4,f.inside));
            addEdge(Edge3D(faces[f.id].e4,f.v4,f.v1,f.inside));
        ...
        else if(direction==FaceDirection::BOTTOM)
        {
            ...
            faces[f.id].e1 = (zOfs)*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e2 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(dims.x+1)+(xOfs+1);
            faces[f.id].e3 = (zOfs+1)*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(2*dims.x+1)+xOfs+(dims.x+1)*(dims.y+1);
            faces[f.id].e4 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(dims.x+1)+(xOfs);
            addEdge(Edge3D(faces[f.id].e1,f.v1,f.v2,f.inside));
            addEdge(Edge3D(faces[f.id].e2,f.v2,f.v3,f.inside));
            addEdge(Edge3D(faces[f.id].e3,f.v3,f.v4,f.inside));
        ...
        else if(direction==FaceDirection::LEFT)
        {
            ...
            faces[f.id].e1 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs+1)*(dims.x+1)+xOfs;
            faces[f.id].e2 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+xOfs+dims.x+(dims.x+1)*(dims.y+1);
            faces[f.id].e3 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(dims.x+1)+xOfs;
            faces[f.id].e4 = (zOfs+1)*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+xOfs+dims.x+(dims.x+1)*(dims.y+1);
            addEdge(Edge3D(faces[f.id].e1,f.v1,f.v2,f.inside));
            addEdge(Edge3D(faces[f.id].e2,f.v2,f.v3,f.inside));
            addEdge(Edge3D(faces[f.id].e3,f.v3,f.v4,f.inside));
            addEdge(Edge3D(faces[f.id].e4,f.v4,f.v1,f.inside));
        ...
        else if(direction==FaceDirection::RIGHT)
        {
            ...
            unsigned int xOfs = ((f.id%(dims.x*dims.y+2*(dims.x+1)*(dims.y+1)-(dims.x+1)-(dims.y+1))-dims.x*dims.y)%(2*dims.x+1))-dims.x;
            faces[f.id].e1 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs+1)*(dims.x+1)+xOfs;
            faces[f.id].e2 = (zOfs+1)*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+xOfs+dims.x+(dims.x+1)*(dims.y+1);
            faces[f.id].e3 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+(yOfs)*(dims.x+1)+xOfs;
            faces[f.id].e4 = zOfs*(((2*(dims.x+1)*(dims.y+1))-(dims.x+1)-(dims.y+1))+((dims.x+1)*(dims.y+1)))+yOfs*(2*dims.x+1)+xOfs+dims.x+(dims.x+1)*(dims.y+1);
            addEdge(Edge3D(faces[f.id].e1,f.v1,f.v2,f.inside));
            addEdge(Edge3D(faces[f.id].e2,f.v2,f.v3,f.inside));
